  ...
  if (submitted) {
    return (
      <div className="register-page">
        <div className="register-background-glow-one" />
        <div className="register-background-glow-two" />
      ...
      <div className="register-card">
        <div className="register-header">
          <div className="register-step-indicator">
            <div className={`register-step-dot ${step >= 1 ? "active" : ""}`}>1</div>
            <div className={`register-step-line ${step >= 2 ? "active" : ""}`} />
            <div className={`register-step-dot ${step >= 2 ? "active" : ""}`}>2</div>
          </div>

          <div className="register-badge">Step {step} of 2</div>
          <h1 className="register-title">Create Your Account</h1>
          <p className="register-subtitle">
            {step === 1
              ? "Fill in your details to continue"
              : "Tell us why we should approve your request"}
          </p>
        </div>
